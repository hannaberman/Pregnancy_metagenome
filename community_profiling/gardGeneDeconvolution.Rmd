...
```{r}
#humann2 outs
dataDir <- "/Volumes/GoogleDrive/My Drive/Callahan Lab/vagMicrobiomeMetagenome/humann2/merged_tables"
...
# read in data frames
GF <- file.path(dataDir, "VM_genefamilies_names.tsv") %>%
  read_delim(delim = "\t") %>% # Gene family abundances
