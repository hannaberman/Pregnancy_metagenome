#!/bin/bash
#SBATCH -o /home/hlberman/VMMG/bbmap_human/log/count_fastq_%j.out
...
filtered_dir=/home/hlberman/VMMG/bbmap_human/filtered_fastq
...
echo $accession ${uploadCount1} ${uploadcount2} ${uploadcountS} ${filteredCount1} ${filteredCount2} ${filteredCountS} >> $out_dir/fastq_counts_bbmap.txt

cat $out_dir/fastq_counts_bbmap.txt