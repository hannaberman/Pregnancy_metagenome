...
# output paths
figureOut <- "/Volumes/GoogleDrive/My\ Drive/Callahan\ Lab/metagenome_gardnerella/FIGURES/V1_manuscript_figures/gard_phyl"
...
gardTable
#save_kable(gardTable, file = file.path(figureOut, "GardRefTable.png"))
```
