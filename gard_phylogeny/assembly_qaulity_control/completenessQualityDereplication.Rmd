...
## File Paths
```{r}
repoPath <- "/Volumes/GoogleDrive/My Drive/Callahan Lab/metagenome_gardnerella/pregnancy_metagenome/gard_phylogeny"
...
figureOut <- file.path(dataPath, "FIGURES/reference_genome_qc")
