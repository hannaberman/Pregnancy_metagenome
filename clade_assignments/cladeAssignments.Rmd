...
subtitle: "Stanford Enriched and UAB Enriched Cohorts"
...
# shotgun metadata
sgDF <- file.path(repoDir, "../METADATA/sumgsDF.tsv") %>%
  read_delim(delim="\t") %>%
...
```
12/70 gene families do not resolve to the clade level
...
```
39/70 gene families do not resolve to the genomospecies level 
