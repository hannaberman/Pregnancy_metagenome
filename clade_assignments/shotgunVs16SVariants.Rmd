...
#shotgun metadata
sgDF <- file.path(repoDir, "shotgunMetadata.tsv") %>%
  read_delim(delim = "\t") %>%
...
nV4 <- gardAllVarDF %>% # number of v4 variants
 ...
 # Number of Clades at each threshold
...
#  Number of Genomospecies at each threshold
...
## Specificity
  Specificity as number of clades or genomospecies that are not supported by a V4 variant
```{r}
