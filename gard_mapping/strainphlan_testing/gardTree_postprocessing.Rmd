...
ref_genomes_df_path <- file.path(input_dir, "gard_mapping","strainphlan_testing", "GardnerellaMetadata.csv")
sg_genomes_df_path <- file.path(input_dir, "shotgunMetadata.tsv")
strainphlan_tree_path <- file.path(input_dir, "gard_mapping","strainphlan_testing", "strainphlan_out", "RAxML_bestTree.g__Gardnerella.tree")
epa_tree_path <- file.path(input_dir, "gard_mapping","strainphlan_testing", "epa", "RAxML_labelledTree.20190217_strainphaln_epaTree.tree")
