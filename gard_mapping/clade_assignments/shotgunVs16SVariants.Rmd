...
ggplot(aes(x=GWcoll, y=propGard, shape=Method, size=Method, color=Var)) +
  ...
  scale_color_manual(values=c("indianred", "red", "blue1", "grey48"), labels=c("Clade C2 (shotgun)",  "G2: Clades 1/2 (V4 amplicon)", "G1: Clades 3/4 (V4 amplicon)", "G3: indeterminant (V4 amplicon)")) + 
  scale_shape_manual(values = c(16, 1)) +
