...
```{r}
#  
# taxaOfInterestAbbr0 <- c("Gv", "C1", "C2", "C3", "C4", "C5", "C6", "Lc", "Lg", "Lj", "Li")
# 
# # DF1 = remove duplicate entries
# DF1 <- DF0 %>%
#   filter(Taxon1 %in% c("G_vaginalis", "C1", "C2", "C3", "C4", "C5", "C6"),
#          Taxon2 %in% c("L_crispatus", "L_gasseri", "L_jensenii", "L_iners")) %>%
#   mutate(Taxon1 = factor(Taxon1, levels=c("G_vaginalis", "C1", "C2", "C3", "C4", "C5", "C6"), labels=c("Gv", "C1", "C2", "C3", "C4", "C5", "C6")),
#          Taxon2 = factor(Taxon2, levels=c("L_crispatus", "L_gasseri", "L_jensenii", "L_iners"), labels=c("Lc", "Lg", "Lj", "Li")))
# 
# # DF2 = sample subset
# DF2 <- DF1 %>%
...
```{r}
# DF1 %>%
#   ggplot(aes(x=absoluteAbundanceTax1)) +
