---
title: "Preterm birth by Cohort and Dominance of Gardnerella"
author: "Hanna Berman"
date: "2/14/2019"
...
output_dir <- "/Volumes/GoogleDrive/My Drive/Callahan Lab/vagMicrobiomeMetagenome/GardPresenceVsMetadata"
...
# PTB by cohort
```{r}
table(df$UAB, df$TermPre)
xtabs(~ UAB + TermPre + PaperCohort, df)
```
