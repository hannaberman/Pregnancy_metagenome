...
output_dir <- file.path(main_dir, "20190220analysisOutput")
...
prepTable16S <- function(dafr_in, abname){
  dafr_out <- dafr_in %>%
    select(SampleID, Taxon, Abundance, PaperCohort)
  colnames(dafr_out) <- c("SampleID_a", "Taxon", abname, "PaperCohort")
  return(dafr_out)}
...
```{r}
#vs. 16S with other:
test <- full_join(sixteenS_toi_o_df,
                  metaphlLG_toi_o_df) %>% 
        full_join(brackenLG_toi_o_df)
        replace_na(list(Abundance_metaphl=0, Abundance_brack=0, Abundance_16S=0))
                        
        mutate(RNAlater = case_when(SampleID_a %in% df$SampleID_a[df$RNAlater=="Yes"] ~ "Yes",
...
meta_brack_16S <- full_join(sixteenS_toi_df0,
                  ...
                  full_join(brackenLG_toi_df0, 
                            by=c("SampleID_a", "Taxon")) %>%
                  replace_na(list(Abundance_metaphl=0, Abundance_brack=0, Abundance_16S=0)) %>%
                  mutate(Abundance_16S=case_when(SampleID_a=="1060401348"~"x")),
...
meta_brack_other <- full_join(metaphlA_toi_o_df0,
                              ...
                              by=c("SampleID_a", "Taxon")) %>%
                    replace_na(list(Abundance_metaphl=0, Abundance_brack=0, Abundance_16S=0)) %>%
                    mutate(Abundance_16S=case_when(SampleID_a=="1060401348"|"1060401158"|"1060401318"|"4003201018"|"4002101018"~NA),
                               RNAlater = case_when(SampleID_a %in% df$SampleID_a[df$RNAlater=="Yes"] ~ "Yes",
                                             SampleID_a %in% df$SampleID_a[df$RNAlater=="No"] ~ "No"))
...
ggplot(data= meta_brack_16S_other) + 
  ...
  ggsave(file.path(output_dir, "Metaphlan16S_byTaxon_o_rnalater.png"))
...
ggplot(data= meta_brack_16S_other) + 
  ...
  coord_fixed() + 
  labs(title = "Proportions:\n16S Amplicon vs. Metaphlan", x="Proportion (Metaphlan)", y="Proportion (16S Amplicon)", color = "Paper Cohort ") #+
  ggsave(file.path(output_dir, "Metaphlan16S_byTaxon_o_papercohort.png"))
```
...
ggplot(data= meta_brack_16S_other) + 
  ...
  ggsave(file.path(output_dir, "Bracken16S_byTaxon_o_rnalater.png"))
ggplot(data= meta_brack_16S_other) + 
  geom_point(aes(x = Abundance_brack, y = Abundance_16S, color=PaperCohort), stat = "identity") + 
  facet_wrap(~Taxon) + 
  coord_fixed() + 
  labs(title = "Porportions:\n16S Amplicon vs. Bracken", x="Proportions (Bracken)", y="Proportions (16S Amplicon)", color = "Paper Cohort") #+
  ggsave(file.path(output_dir, "Bracken16S_byTaxon_o_papercohort.png"))
```
...
ggplot(data= meta_brack_16S) + 
  ...
  coord_fixed() + 
  labs(title = "Proportions:\n16S Amplicon vs. Metaphlan", x="Proportion (Metaphlan)", y="Proportion (16S Amplicon)", color = "Paper Cohort") #+
  ggsave(file.path(output_dir, "Metaphlan16S_byTaxon_rnalater.png"))
...
ggplot(data= meta_brack_16S) + 
  ...
  coord_fixed() + 
  labs(title = "Proportions:\n16S Amplicon vs. Metaphlan", x="Proportion (Metaphlan)", y="Proportion (16S Amplicon)", color = "Paper Cohort") #+
  ggsave(file.path(output_dir, "Metaphlan16S_byTaxon_papercohort.png"))
```
...
ggplot(data= meta_brack_16S) + 
  ...
  ggsave(file.path(output_dir, "Bracken16S_byTaxon_rnalater.png"))
...
ggplot(data= meta_brack_16S) + 
  ...
  coord_fixed() + 
  labs(title = "Proportions:\n16S Amplicon vs. Bracken", x="Proportion (Bracken)", y="Proportion (16S Amplicon)", color = "Paper Cohort") #+
  ggsave(file.path(output_dir, "Bracken16S_byTaxon_papercohort.png"))
```
