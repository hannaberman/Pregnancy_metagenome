...
readCounts_path <- "/Volumes/GoogleDrive/My Drive/Callahan Lab/vagMicrobiomeMetagenome/merged_braken_KrakenReads_pe.tsv"
output_dir <- getwd()
df <- "/Users/hlberman/Documents/GitHub/pregnancy_metagenome/shotgunMetadata.tsv"
```
...
write_delim(humanTable1, file.path(output_dir, "krakenHumanReads.tsv"), delim = "\t")
